...
org:
  ...
  contextual_skills: []
  required_knowledge:
    - analytics-measurement-framework.md
    - cro-experimentation-framework.md
    - cro-research-heuristics.md
...
- `{{DRAX_ASSETS}}/knowledge/ux-conversion-design.md` — CONTEXTUAL — load when the heuristic analysis surfaces a conversion design pattern issue (e.g., CTA placement, form field reduction, trust signal positioning). Provides the design pattern library for the Clarity and Anxiety factors in the LIFT analysis. STATUS: stub (exists in knowledge/).
- `{{DRAX_ASSETS}}/knowledge/ux-onboarding-patterns.md` — CONTEXTUAL — load when the audit surface is an onboarding flow or activation sequence. Contains onboarding design patterns that contextualize Fogg Behavior analysis findings and inform variant design options. STATUS: stub (exists in knowledge/).
- `{{DRAX_ASSETS}}/knowledge/marketing-funnel-frameworks.md` — CONTEXTUAL — load when mapping the surface being audited to a funnel stage (TOFU/MOFU/BOFU) and when framing test results in terms of funnel-stage conversion impact for the CMO report. STATUS: stub (exists in knowledge/).
- `{{DRAX_ASSETS}}/knowledge/marketing-paid-traffic.md` — CONTEXTUAL — load when the audit or test is triggered by a paid channel landing page. Provides the channel execution context needed to interpret traffic quality issues vs. landing page issues — prevents misattributing a traffic quality problem to a conversion UX problem. STATUS: stub (exists in knowledge/).
...
Step 4: Load REQUIRED skills based on surface type:
  - All surfaces: load `{{DRAX_ASSETS}}/protocols/fogg-behavior.md` and `{{DRAX_ASSETS}}/protocols/aha-moment.md`
  - If paid channel landing page: load `{{DRAX_ASSETS}}/protocols/channel-hypothesis.md`
  - If positioning/message-match is a concern: load `{{DRAX_ASSETS}}/protocols/positioning.md`
Step 5: Load REQUIRED knowledge docs:
  - `{{DRAX_ASSETS}}/knowledge/cro-research-heuristics.md` — ResearchXL protocol, LIFT model, PIE framework
  - `{{DRAX_ASSETS}}/knowledge/cro-experimentation-framework.md` — statistical protocol, SRM check, peeking rules
  - `{{DRAX_ASSETS}}/knowledge/analytics-measurement-framework.md` — funnel analytics interpretation
Step 6: Identify task type from activation input:
  ...
  **BACKLOG MODE — Experiment backlog update:**
  - Load CONTEXTUAL skill: `{{DRAX_ASSETS}}/protocols/ltv-cac-gate.md` for revenue impact estimation
  ...
  **EXPERIMENT MODE — A/B test result interpretation:**
  - Load REQUIRED knowledge: `{{DRAX_ASSETS}}/knowledge/cro-experimentation-framework.md`
  ...
  **REPORT MODE — Monthly CRO performance report:**
  - Load CONTEXTUAL skill: `{{DRAX_ASSETS}}/protocols/ltv-cac-gate.md` for revenue impact of shipped tests
