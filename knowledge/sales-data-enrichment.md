...
This document covers how lead, contact, and account records should be enriched before they are used in Drax sales workflows. It defines required field categories, source-order logic, confidence notation, waterfall enrichment structure, pre-handoff readiness rules, and segment-specific enrichment expectations.
