...
This document defines the sprint-based editorial planning cycle, Content Type Matrix, production capacity methodology, and editorial calendar governance protocol used by the Content Strategist in Drax.
...
### Capacity by Executor (Drax context — agent-based)
